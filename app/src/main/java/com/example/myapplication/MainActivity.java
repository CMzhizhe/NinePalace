...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (currentValue >= 0 && currentValue <= totalWidth) {//第一排
                    ...
                    flWorkKuangLayout.setTranslationY(twelveLuckPanLayout.getChildAt(6).getTop() - twelveLuckPanLayout.getItemSpace());
    ...
    public void onPosition(final int position, final int resultLeng) {
        final int totalWidth = twelveLuckPanLayout.getmRectParentWidth() - twelveLuckPanLayout.getmRectParentWidth() / 4;//一条直线上的
        final int oneItem = twelveLuckPanLayout.getmRectParentWidth() / 4;//一个的Item
        final ValueAnimator valueAnimator = ValueAnimator.ofInt(0, resultLeng);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int currentValue = (int) animation.getAnimatedValue();
        ...
        valueAnimator.setInterpolator(new MyInterceperV2());
        valueAnimator.setDuration(1000);
        valueAnimator.start();
    }
